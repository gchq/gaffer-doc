...
public class ToTrailingWildcardPairExample extends FunctionExample {
    ...
    private void withCustomEndOfRange() {
        // ---------------------------------------------------------
        final ToTrailingWildcardPair function = new ToTrailingWildcardPair();
        function.setEndOfRange("custom");
        // ---------------------------------------------------------
        String description = "The end of range is customisable";
        runExample(function, description,  "value1", "value2", null);
    }
}
