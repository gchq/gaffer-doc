...
public class CollectionIntersectExample extends BinaryOperatorExample {

    public CollectionIntersectExample() {
        super(CollectionIntersect.class, "Returns items common to two collections");
    }
