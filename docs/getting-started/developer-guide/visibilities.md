...
The code for this example is [Visibilities](https://github.com/gchq/gaffer-doc/blob/master/src/main/java/uk/gov/gchq/gaffer/doc/dev/walkthrough/Visibilities.java).
...
We also specified that the visibility property is serialised using the custom [VisibilitySerialiser](https://github.com/gchq/gaffer-doc/blob/master/src/main/java/uk/gov/gchq/gaffer/doc/dev/serialiser/VisibilitySerialiser.java) and aggregated using the [VisibilityAggregator](https://github.com/gchq/gaffer-doc/blob/master/src/main/java/uk/gov/gchq/gaffer/doc/dev/aggregator/VisibilityAggregator.java) binary operator.
