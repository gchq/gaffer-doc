...
## Coding style
Please ensure your coding style is consistent with rest of the Gaffer project; your changes should pass the checkstyle and spotless plugin checks when running `mvn clean install`. These check code for formatting and licenses and are part of the continuous integration pipeline.
