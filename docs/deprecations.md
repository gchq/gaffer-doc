...
- Use `uk.gov.gchq.gaffer.serialisation.implementation.ordered.OrderedDateSerialiser` instead - note that this will preserve order. This doesn't implement `.deserialiseString(final String value)`, instead use `new Date(Long.parseLong(value))` in place of this.
...
- This has been removed.
- Use `uk.gov.gchq.gaffer.serialisation.implementation.ordered.OrderedDoubleSerialiser` instead - note that this will preserve order. This doesn't implement `.deserialiseString(final String value)`, instead use `Double.parseDouble(value)` in place of this.
...
- Neither of these implement `.deserialiseString(final String value)`, instead use `Integer.parseInt(value)` in place of this.
